...
| Inherits from `BaseModel` | Inherits from `BaseModel` 
| Inherits from `BaseModel` | Inherits from `BaseModel` 
| Inherits from `BaseModel` | Inherits from `BaseModel` |
| **PUBLIC INSTANCE METHODS** | `save`<br>`to_dict` 
| `all`<br>`new`<br>`save`<br>`reload` | "" | "" | "" | "" | "" | "" |
| **PUBLIC CLASS ATTRIBUTES** | | 
| `email`<br>`password`<br>`first_name`<br>`last_name`| `name` 
| `state_id`<br>`name` | `name` 
| `city_id`<br>`user_id`<br>`name`<br>`description`<br>`number_rooms`<br>
`number_bathrooms`<br>`max_guest`<br>`price_by_night`<br>`latitude`<br>
`longitude`<br>`amenity_ids` | `place_id`<br>`user_id`<br>`text` | 
| **PRIVATE CLASS ATTRIBUTES** | | `file_path`<br>`objects` | | | | | | |
|File|[base_model.py](./models/base_model.py)
|[file_storage.py](./models/engine/file_storage.py)|[user.py](./models/user.py)
|[state.py](./modesl/state.py)|[city.py](./models/city.py)
|[amenity.py](./models/amenity.py)|[place.py](./models/place.py)
...
```
git clone https://github.com/Jaytru1997/AirBnB_clone.git
```
...
* **Oghenekparobo Onosemuode** [Oghenekparobo Onosemuode](kparaboj@gmail.com)
